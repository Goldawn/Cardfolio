/*
  ...
  - You are about to drop the column `showcasedCard` on the `Decklist` table. All the data in the column will be lost.
...
INSERT INTO "new_Decklist" ("colors", "createdAt", "format", "id", "name", "updatedAt", "userId") SELECT "colors", "createdAt", "format", "id", "name", "updatedAt", "userId" FROM "Decklist";
DROP TABLE "Decklist";
