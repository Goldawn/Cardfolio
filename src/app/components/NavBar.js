    ...
    <nav>
      <ul id={styles.mainUl}>
        ...
        <li className={`${styles.mainMenu} ${styles.lorcanaBg}`}>
          <Link href="/lorcana">
            <div className={styles.linkdiv}>
              <Image src={lorcanaLogo} width={180} height={85} alt={"Logo Lorcana"}/>
            </div>
          </Link>
        </li>
        ...
        <li className={`${styles.mainMenu} ${styles.pkmnBg}`}>
          <Link href="/pokemon">
            <div className={styles.linkdiv}>
              <Image src={pkmnLogo} width={180} height={140} alt={"Logo Pokemon"}/>
            </div>
          </Link>
        </li>
        ...
        <li className={`${styles.mainMenu} ${styles.riftboundBg}`}>
          <Link href="/riftbound">
            <div className={styles.linkdiv}>
              <Image src={riftboundLogo} width={180} height={80} alt={"Logo Riftbound"}/>
            </div>
          </Link>
        </li>
