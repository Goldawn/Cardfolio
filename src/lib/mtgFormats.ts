...
export const FORMAT_DESCRIPTIONS: Record<MTGFormat, string> = {
  ...
  modern: '60+ cartes, max 4 exemplaires sauf cartes explicitement illimitées.',
  legacy: '60+ cartes, max 4 exemplaires sauf cartes explicitement illimitées.',
  pioneer:
    '60+ cartes, max 4 exemplaires sauf cartes explicitement illimitées.',
  standard:
    '60+ cartes, max 4 exemplaires sauf cartes explicitement illimitées.',
  historic: '60+ cartes, format Arena.',
  timeless: '60+ cartes, Arena (pool étendu).',
