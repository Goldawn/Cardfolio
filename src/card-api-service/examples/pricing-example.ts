...
import { CardServiceFactory, PricingService } from '../index'
...
export async function fallbackPricingExample() {
  ...
  try {
    ...
    const price = await pricingService.fetchCardPriceByNameWithFallback('Black Lotus')
...
export async function compatibilityExample() {
  ...
  try {
    ...
    const simplePriceById = await pricingService.fetchSimplePriceById('9ea8179a-d3c9-4cdc-a5b5-68cc73279050')
